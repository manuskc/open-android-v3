        ...
        public void onItemClick(View childView, int position) {
            ...
            try {
                ...
                if (paymentType == Utils.PaymentType.LOAD_MONEY) {
                    ...
                    paymentType1 = new PaymentType.LoadMoney(amount, authenticationSignatures.getRETURN_URL_LOAD_MONEY(), netbankingOption);
...
//                    paymentType1 = new PaymentType.LoadMoney(amount, Constants.RETURN_URL_LOAD_MONEY, netbankingOption);
                    ...
                    paymentType1 = new PaymentType.PGPayment(amount, authenticationSignatures.getBILL_URL(), netbankingOption, new CitrusUser(client.getUserEmailId(), client.getUserMobileNumber()));
