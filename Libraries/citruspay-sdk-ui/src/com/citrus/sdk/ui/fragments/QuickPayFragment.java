...
//    List<NetbankingOption> savedBankListLess;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setupWalletText = (TextView) layout.findViewById(R.id.setup_wallet_text);
        ...
        for (int i = 0; i < totalSize; i++) {
            if (paymentOptions.get(i) instanceof NetbankingOption) {
                ...
                if (isAdded()) {
                    ...
                    TextView cardNumber = (TextView) savedCardItem.findViewById(R.id
                            .card_number);
